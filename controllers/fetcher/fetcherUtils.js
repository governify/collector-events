  ...
  return new Promise((resolve, reject) => {
    ...
    if (includesTemporalDB(cacheKey)) {
      ...
      governify.httpClient.request(options).then(data => {
        ...
        setTemporalDB(cacheKey, data.data);
        setTimeout(() => {
